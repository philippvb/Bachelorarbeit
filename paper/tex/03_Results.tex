...
That's probably due to the smaller learning rate at the end of each cycle for
...
\begin{figure}[h]
    \begin{center}
        \begin{tikzpicture}
            ...
            \end{groupplot}        
        \end{tikzpicture}
        \caption{Validation accuracy of multiple checkpoints from \ref{res:Multiple} compared to cosine decay with warm restart for MobileNetV2 (left) and ResNet32 (right).}
...
For the network trained with distance function, we start with the same epoch
