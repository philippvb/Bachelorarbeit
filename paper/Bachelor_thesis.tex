...
Escaping local minima in DNNs by rewarding different parameter values
\end{tabular}}
...
\textbf{Betreuer:} 	& Prof.\,Dr.~Andreas Zell\\
...
\begin{abstract}
% \textbf{Kurzfassung. }\input{tex/00a_Kurzfassung}
\end{abstract}
...
\input{tex/02_Methods.tex}
\input{tex/03_Results.tex}
\input{tex/04_Discussion.tex}
%\input{tex/05_Summary.tex}
...
%\appendix
%\input{tex/0A_Abkuerzungsverzeichnis}
