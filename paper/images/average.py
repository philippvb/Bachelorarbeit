...
def average():
    directory = 'paper/images/network_csv/multiple/MobileNetV2/run-'
    networkname= 'mobileNetV2_multiple_merge' # 'ResNet32_strength_e1'2
    ...
    out_name= 'paper/images/network_csv/multiple/MobileNetV2/MobileNetV2_multiple_merge_validation_acuracy.csv'
    #out_name= 'paper/images/network_csv/multiple/MobileNetV2/MobileNetV2_multiple_merge_distance0.csv'
