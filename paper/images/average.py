...
def average():
    directory = 'paper/images/network_csv/ensemble/MobileNetV2/'
    networkname= 'mobileNetV2_ensemble_distance' # 'ResNet32_strength_e1'2
    ...
    out_names=[
        directory + newName + '_Ensemble_accuracy.csv'#,
