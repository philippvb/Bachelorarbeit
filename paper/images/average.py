...
def average():
    directory = 'paper/images/network_csv/multiple/MobileNetV2/'
    networkname= 'MobileNetV2_multiple' # 'ResNet32_strength_e1'2
    #out_directory = 'paper/images/network_csv/baseline/MobileNetV2/'
    newName = 'ResNet32_scheduler_step'
